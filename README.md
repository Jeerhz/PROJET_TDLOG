...
+ bien sur Django Pillow docxtpl openpyxl celery django_celery_beat psycopg psycopg2-binary pytz num2words django-crispy_forms html2image python-decouple django-multiselectfield django-debug-toolbar loguru
