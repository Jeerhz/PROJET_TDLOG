    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('debut', models.DateField(blank=True, default=django.utils.timezone.now)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type_facture', models.CharField(choices=[("Facture d'acompte", 'Acompte'), ('Facture intermédiaire', 'Intermediaire'), ('Facture de solde', 'Solde')], default='Facture de solde', max_length=100)),
