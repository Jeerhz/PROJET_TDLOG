# Generated by Django 5.0.6 on 2024-08-06 21:45
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('logo', models.ImageField(default='media/polls/Logo_Ecole_des_Ponts_ParisTech.svg.png', upload_to='polls/')),
                ...
                ('_type', models.CharField(choices=[('GRANDE_ENTREPRISE', 'Grande entreprise'), ('SECTEUR_PUBLIC', 'Secteur Public'), ('START_UP_ET_TPE', 'Start-up et TPE'), ('PME', 'Petite et moyenne entreprise'), ('ETI', 'Entreprise de taille intermédiaire'), ('ASSOCIATION', 'Association')], default='SECTEUR_PUBLIC', help_text="Sélectionnez le type d'entreprise.", max_length=20)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('poste', models.CharField(choices=[('PRESIDENT', 'président'), ('VICE_PRESIDENT', 'vice-président'), ('TRESORIER', 'Trésorier'), ('VICE_TRESORIER', 'vice-trésorier'), ('SECRETAIRE_GENERALE', 'secrétaire générale'), ('CHEF_DE_PROJET', 'chef de projet'), ('DIRECTEUR_COMMERCIALE', 'directeur commerciale'), ('DIRECTEUR_PROJET', 'directeur projet'), ('DSI', 'DSI'), ('RESPONSABLE_QUALITE', 'responsable_qualite'), ('DIRECTEUR_COMMUNICATION', 'directeur communication'), ('DIRECTEUR_RSE', 'directeur RSE')], default='PRESIDENT', max_length=40)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('numero', models.IntegerField()),
                ('remarque', models.TextField(blank=True, null=True)),
                ('convention_cadre', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='bons_commande', to='polls.conventioncadre')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_signature', models.DateField(blank=True, null=True)),
                ('remarque', models.TextField(blank=True, null=True)),
                ('ce', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='avenants_modification', to='polls.conventionetude')),
            ],
        ),
        migrations.CreateModel(
            name='Etude',
            fields=[
                ...
                ('resp_qualite', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='qualite_etudes', to=settings.AUTH_USER_MODEL)),
                ('responsable', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='responsable_etudes', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.AddField(
            ...
            name='etude',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='conventions_etude', to='polls.etude'),
        ),
        migrations.AddField(
            model_name='conventioncadre',
            name='etude',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='conventions_cadre', to='polls.etude'),
        ),
        migrations.CreateModel(
            name='Facture',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('etude', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='phases', to='polls.etude')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('departement', models.CharField(choices=[('IMI', 'IMI'), ('SEGF', 'SEGF'), ('GMM', 'GMM'), ('1A', '1A'), ('GCC', 'GCC'), ('VET', 'VET'), ('AUTRE', 'Autre')], default='AUTRE', max_length=20)),
                ('numero_ss', models.CharField(default='0', max_length=14, validators=[django.core.validators.RegexValidator('^[0-9]+$', 'This field must only contain digits')])),
                ('je', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='polls.je')),
            ],
        ),
        migrations.AddField(
            model_name='rdm',
            name='eleve',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='rdm', to='polls.student'),
        ),
        migrations.CreateModel(
            name='Candidature',
            fields=[
        ...
        migrations.AddField(
            model_name='member',
            name='student',
            field=models.OneToOneField(null=True, on_delete=django.db.models.deletion.CASCADE, to='polls.student'),
        ),
        migrations.CreateModel(
