# Generated by Django 4.2.11 on 2024-07-27 16:15
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "derniere_reponse",
                    models.DateField(default=datetime.date(1747, 1, 1)),
                ),
                (
                    "client",
                    models.ForeignKey(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "liste_phases_supprimees",
                    models.ManyToManyField(
                        blank=True, related_name="avenant_suppression", to="polls.phase"
                    ),
                ),
            ],
        ),
