# Generated by Django 4.2.16 on 2024-10-07 07:40
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "frais_dossier",
                    models.FloatField(default=0, verbose_name="frais de dossier"),
                ),
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        choices=[("025", "025"), ("026", "026"), ("027", "027")],
                        default="026",
                        max_length=30,
                        verbose_name="mandat",
                    ),
                ...
                (
                    ...
                    models.TextField(
                        ...
                        default="",
                        null=True,
                        verbose_name="éléments à fournir du client",
                    ),
                ),
                (
                ...
                (
                    "suivi_document",
                    models.JSONField(default=polls.models.Etude.default_suivi_document),
                ),
                (
                    "client",
                    models.ForeignKey(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "adress",
                    models.CharField(max_length=300, null=True, verbose_name="rue"),
                ),
                (
                    "ville",
                    models.CharField(
                ...
                (
                    "country",
                    models.CharField(max_length=100, null=True, verbose_name="pays"),
                ),
                (
                    "promotion",
                    models.CharField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.BooleanField(default=True, verbose_name="En discussion"),
                ),
                (
                    "param_statut_etude_t",
                    models.BooleanField(default=True, verbose_name="Terminée"),
                ),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "facture_pdf",
                    models.FileField(blank=True, null=True, upload_to="factures/pdfs/"),
                ),
                (
                    "etude",
                    models.ForeignKey(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="associations_phase",
                        to="polls.boncommande",
                    ),
                ),
                (
                    "phase",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="associations_facture",
                        to="polls.boncommande",
                    ),
                ),
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="associations_bdc_fac",
                        to="polls.facture",
                    ),
                ),
            ],
