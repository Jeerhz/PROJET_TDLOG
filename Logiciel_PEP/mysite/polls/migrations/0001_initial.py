# Generated by Django 5.0.6 on 2024-10-06 18:56
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('secteur', models.CharField(choices=[('INDUSTRIE', 'Industrie'), ('DISTRIBUTION', 'Distribution'), ('SECTEUR_PUBLIC', 'Secteur Public'), ('CONSEIL', 'Conseil'), ('TRANSPORT', 'Transport'), ('NUMERIQUE', 'Numérique'), ('BTP', 'BTP'), ('ENERGIE', 'Énergie'), ('ADMINISTRATIF', 'Administratif'), ('RECHERCHE', 'Recherche'), ('TELECOM', 'Télécom'), ('FINANCECOMPTA', 'Finance-compta'), ('AUTRE', 'Autre')], default='SECTEUR_PUBLIC', help_text="Sélectionnez le secteur d'activité du client.", max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('resp_qualite', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='qualite_etudes', to=settings.AUTH_USER_MODEL, verbose_name='qualité')),
                ('responsable', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='responsable_etudes', to=settings.AUTH_USER_MODEL, verbose_name='suiveur')),
