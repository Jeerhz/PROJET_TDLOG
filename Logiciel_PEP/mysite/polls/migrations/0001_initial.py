    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('logo', models.ImageField(upload_to='polls/')),
                ('secteur', models.CharField(choices=[('INDUSTRIE', 'Industrie'), ('DISTRIBUTION', 'Distribution'), ('SECTEUR PUBLIC', 'Secteur Public'), ('CONSEIL', 'Conseil'), ('TRANSPORT', 'Transport'), ('NUMERIQUE', 'Numerique'), ('BTP', 'BTP'), ('AUTRE', 'Autre')], default='SECTEUR PUBLIC', help_text="Sélectionnez le secteur d'activité du client.", max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('fichier', models.FileField(storage='polls/', upload_to='polls/')),
            ],
        ),
        migrations.CreateModel(
            name='JE',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type_convention', models.CharField(blank=True, choices=[('Convention cadre', 'Cadre'), ("Convention d'étude", 'Etude')], verbose_name='Type de convention')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type_facture', models.CharField(choices=[("Facture d'acompte", 'Acompte'), ('Facture intermédiaire', 'Intermediaire'), ('Facture de solde', 'Solde')], default='Facture de solde', max_length=30)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('utilisateur', models.ManyToManyField(blank=True, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Phase',
