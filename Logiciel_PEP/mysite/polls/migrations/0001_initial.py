    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('resp_qualite', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
        ...
        migrations.AddField(
            model_name='etude',
            name='responsable',
            field=models.ManyToManyField(blank=True, to='polls.responsable'),
        ),
        migrations.CreateModel(
            name='Student',
            fields=[
